...
Reading: In average the alert function was able to handle approx one track every 2.94425s.
In other word, a single instance of the ~stream~ operator can handle 0.3 track per second.
